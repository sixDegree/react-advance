...
/******/ 	var hotCurrentHash = "739bc24b6b27a69f5a2b"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router=__webpack_require__(171).Router;
	...
	var createBrowserHistory =__webpack_require__(222);
	ReactDOM.render(React.createElement(Router, {routes: routes, history: createBrowserHistory()}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header=React.createClass({displayName: "Header",
		...
		render:function(){
			var navs=this.props.navigations.map(function(nav,index){
	  			...
	  			return React.createElement("li", {key: index}, React.createElement(Link, {to: nav.url, activeClassName: "active"}, nav.title))
	      	})
			return (
				React.createElement("nav", {className: "navbar navbar-default"}, 
				  React.createElement("div", {className: "container"}, 
				    React.createElement("div", {className: "navbar-header"}, 
				      React.createElement("button", {type: "button", className: "navbar-toggle collapsed", "data-toggle": "collapse", "data-target": "#navigation"}, 
				        React.createElement("span", {className: "sr-only"}, "Toggle navigation"), 
				        React.createElement("span", {className: "icon-bar"}), 
				        React.createElement("span", {className: "icon-bar"}), 
				        React.createElement("span", {className: "icon-bar"})
				      ), 
				      React.createElement(Link, {className: "navbar-brand", to: "/"}, this.props.title)
				    ), 

				    React.createElement("div", {className: "collapse navbar-collapse", id: "navigation"}, 
	...
	var Child=React.createClass({displayName: "Child",
		render:function(){
			return (
				React.createElement("h3", null, " I am Child ", this.props.params.id, " ! ")
			)
		}
	});
	...
	var NoMatch=React.createClass({displayName: "NoMatch",
		render:function(){
			return (React.createElement("h3", null, "No Match !"))
		}
	})
		...
		render:function(){
			return (
				React.createElement("div", null, 
					React.createElement(Header, React.__spread({},  this.props.route.headerProps)), 
					React.createElement("div", {className: "container"}, 
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(219); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "routes.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
